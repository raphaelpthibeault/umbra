...
void 
isr_exception_handler(struct isr_xframe *frame)
{
	serial_print("[FATAL] %s:\r\n\n", exception_labels[frame->base_frame.vector]);

	/* note exactly the most graceful exception handling */
	while (1) 
	{
